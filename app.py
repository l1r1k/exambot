...
DBS_TABLE_DESCRIPTION = {
    ...
    'restaurantdb': 'Таблица clients - Клиенты ресторана;\nТаблица waiters - Официанты;\nТаблица dishes - Блюда, которые продаются; Таблица orders - Заказы; Таблица orderitems - Состав заказов',
    'albumshopdb': 'Таблица shop_new_order - Заказы нового магазина; Таблица shop_new_visit - Визиты посетителей в новом магазине; Таблица shop_old_order - Заказы старого магазина; Таблица shop_old_visit - Визиты посетителей в старом магазине',
}
